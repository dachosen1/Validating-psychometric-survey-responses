...
good_users = pd.read_csv('/Users/luislosada/PycharmProjects/Dotin-Columbia-Castone-Team-Alpha/Data/Extra/List_Good_User.csv',index_col=0).reset_index(drop=True)
good_users
...
plt.scatter(finalDf[finalDf['cluster']==1]['principal component 1'],finalDf[finalDf['cluster']==1]['principal component 2'],alpha=0.75, c='red',label = 'Outlier')
plt.scatter(finalDf[finalDf['cluster']==0]['principal component 1'],finalDf[finalDf['cluster']==0]['principal component 2'],alpha=0.75, c='green',label = "Non Outlier")
