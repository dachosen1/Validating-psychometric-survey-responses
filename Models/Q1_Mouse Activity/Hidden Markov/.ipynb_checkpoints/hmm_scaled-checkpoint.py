...
class HMM:
	...
	def fit(self, X, max_iter=30):
		...
		# print("initial A:", self.state_transition_matrix)
		# print("initial B:", self.output_distribution)
		...
		for it in range(max_iter):
			...
			# now re-estimate the initial state distribution, transition matrix, and output distibution
...
# 		print("A:", self.state_transition_matrix)
# 		print("B:", self.output_distribution)
# 		print("pi:", self.initial_state_distribution)
